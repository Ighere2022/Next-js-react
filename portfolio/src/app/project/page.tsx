...
const Project = () => {
  return (
    <section className="container mx-auto min-h-screen flex items-center justify-center p-4 flex-col">
      <h1 className="text-6xl my-8 font-semibold">Projects iv'e done!</h1>
